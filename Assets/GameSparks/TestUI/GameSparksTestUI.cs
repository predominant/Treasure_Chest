...
public class GameSparksTestUI : MonoBehaviour
{
    ...
    private string gpToken = "accessToken";
	...
	void OnGUI ()
	{
        ...
        //if (GUILayout.Button("googlePlusConnectRequest", GUILayout.Width(itemWidth), GUILayout.Height(itemHeight)))
        //{
        //    new GooglePlusConnectRequest().SetAccessToken(gpToken).Send((response) =>
        //        {
        //            HandleLog("FacebookConnectRequest.HasErrors:" + response.HasErrors);
        //            HandleLog("FacebookConnectRequest.UserId:" + response.UserId);
        //        });
        ...
        //gpToken = GUILayout.TextField (gpToken, GUILayout.Width (itemWidth), GUILayout.Height (itemHeight));
