...
{
	private static Dictionary<System.Type,List<KGFObject>> itsListSorted = new Dictionary<System.Type, List<KGFObject>>();
	
	private static Dictionary<System.Type,KGFDelegate> itsListEventsAdd = new Dictionary<System.Type, KGFDelegate>();
	private static Dictionary<System.Type,KGFDelegate> itsListEventsAddOnce = new Dictionary<System.Type, KGFDelegate>();
	private static Dictionary<System.Type,KGFDelegate> itsListEventsRemove = new Dictionary<System.Type, KGFDelegate>();
	...
	public static void AddKGFObject(KGFObject theObjectScript)
	{
		...
		System.Type anObjectScriptType = theObjectScript.GetType();
		...
		foreach (System.Type aKeyType in itsListEventsAdd.Keys)
		{
		...
		if (itsListEventsAddOnce.Count > 0)
		{
			...
			List<System.Type> aTypeList = new List<System.Type>();
			foreach (System.Type aKeyType in itsListEventsAddOnce.Keys)
			{
				if (aKeyType.IsAssignableFrom(anObjectScriptType))
					aTypeList.Add(aKeyType);
			}
			foreach (System.Type aType in aTypeList)
			{
	...
	public static void RemoveKGFObject(KGFObject theObjectScript)
	{
		...
		foreach (System.Type aKeyType in itsListEventsRemove.Keys)
		{
			if (aKeyType.IsAssignableFrom(anObjectScriptType))
	...
	public static void GetExternal<T>(System.Action<object,System.EventArgs> theRegisterCallback)
	{
		T aT = GetObject<T>();
		if (aT != null)
	...
	/// </summary>
	/// <param name="theCallback"></param>
	public static void RegisterAddEvent<T>(System.Action<object,System.EventArgs> theCallback)
	{
		if (theCallback == null)
			return;
	...
	/// </summary>
	/// <param name="theCallback"></param>
	public static void RegisterAddOnceEvent<T>(System.Action<object,System.EventArgs> theCallback)
	{
		if (theCallback == null)
			return;
		System.Type theType = typeof(T);
	...
	/// </summary>
	/// <param name="theCallback"></param>
	public static void UnregisterAddEvent<T>(System.Action<object,System.EventArgs> theCallback)
	{
		System.Type theType = typeof(T);
		if (itsListEventsAdd.ContainsKey(theType))
			itsListEventsAdd[theType] -= theCallback;
	...
	/// </summary>
	/// <param name="theCallback"></param>
	public static void UnregisterRemoveEvent<T>(System.Action<object,System.EventArgs> theCallback)
	{
		System.Type theType = typeof(T);
		if (itsListEventsRemove.ContainsKey(theType))
			itsListEventsRemove[theType] -= theCallback;
	...
	/// </summary>
	/// <returns></returns>
	public static List<object> GetObjects(System.Type theType)
	{
	...
	/// </summary>
	/// <returns></returns>
	public static object GetObject(System.Type theType)
	{
	...
	/// </summary>
	/// <returns></returns>
	public static IEnumerable<System.Type> GetObjectCacheListTypes()
	{
		foreach (System.Type aType in itsListSorted.Keys)
			yield return aType;
		yield break;
	...
	/// <returns></returns>
	public static int GetObjectCacheListCountByType(System.Type theType)
	{
