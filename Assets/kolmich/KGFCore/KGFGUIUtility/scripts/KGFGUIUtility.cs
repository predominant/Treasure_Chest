...
public class KGFGUIUtility
{
	...
	private static string[] itsDefaultGuiSkinPath = new string[2]{"KGFSkins/default/skins/skin_default_16","KGFSkins/default/skins/skin_default_32"};
	...
	private static void Init(bool theForceInit)
	{
		...
		//TODO: check if this can be deleted, or must be uncommented again for some reason. at the moment it only creates errors for classes that are derived from KGFEditor
