    ...
    public partial class InventoriesCollectionEventsProxy : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            foreach (var c in InventoryManager.GetLootToCollections())
            {
                ...
                c.OnUnstackedItemCollectionFull += OnUnstackedItemCollectionFullPly;
        ...
        private void OnUnstackedItemCollectionFullPly(uint slot)
        {
            if (eventHandler != null)
                eventHandler.CollectionOnUnstackedItemCollectionFull(slot);
        }
