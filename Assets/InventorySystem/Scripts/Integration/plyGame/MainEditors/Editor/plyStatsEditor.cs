...
namespace Devdog.InventorySystem.Integration.plyGame.Editors
{
    public class plyStatsEditor : IInventorySystemEditorCrud
    {
        ...
        public virtual void Draw()
        {
            ...
            // update.., ply changed
            if (plyAttributes.Count != InventoryEditorUtility.selectedDatabase.plyAttributes.Length)
            {
                var newAtts = attributes;
                var currentAtts = InventoryEditorUtility.selectedDatabase.plyAttributes;
                ...
                InventoryEditorUtility.selectedDatabase.plyAttributes = newAtts;
                resultList.list = InventoryEditorUtility.selectedDatabase.plyAttributes;
            }
