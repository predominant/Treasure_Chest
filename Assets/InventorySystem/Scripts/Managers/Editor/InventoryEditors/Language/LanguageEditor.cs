...
{
    public class LanguageEditor : InventorySystemEditorCrudBase<LanguageEditor.Lookup>
    {
        public class Lookup
        {
        ...
        protected InventoryLangDatabase _language;
        protected InventoryLangDatabase language
        {
            get
            {
                if (_language == null)
                    _language = InventoryEditorUtility.GetLangDatabase();
